      ...
      <div className="container">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6 items-center space-y-10 xl:space-y-0">
          <div className="space-y-6 text-center xl:text-left">
            ...
            <div
              className="space-y-2 md:space-x-5 gap-4 mt-10 flex flex-col md:flex-row justify-center xl:justify-start"
            ...
            <div className="col-span-12 md:col-span-6 d2c_hero_card d2c_card flex items-center order-1" data-aos="fade-up" data-aos-delay="400">
              <div className="space-y-3 text-center md:text-left">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-block text-light-green text-sm underline underline-offset-4"
                >
                  Falar no WhatsApp
                </a>
              </div>
